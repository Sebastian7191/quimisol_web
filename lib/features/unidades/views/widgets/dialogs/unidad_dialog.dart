...
class UnidadDialog extends StatefulWidget {
  final String title;
  ...
  @override
  State<UnidadDialog> createState() => _UnidadDialogState();
}

class _UnidadDialogState extends State<UnidadDialog> {
  ...
  void initState() {
    ...
    _abrevCtrl =
        TextEditingController(text: widget.initialAbreviatura ?? '');
    _descCtrl =
                  ...
                  children: [
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText:
                            'Nombre de la unidad (Ej: Kilogramo)',
                        filled: true,
